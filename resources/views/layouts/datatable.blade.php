...
<head>
    ...
    <!-- Bootstrap core CSS     -->
    <link href="{{ asset('public/datatable') }}/css/bootstrap.min.css" rel="stylesheet" />
    <!-- Datatable core CSS     -->
    <link href="{{ asset('public/datatable') }}/css/dataTables.bootstrap.min.css" rel="stylesheet" />
...
<!--   Core JS Files   -->
<script type="text/javascript" src="{{ asset('public/datatable') }}/js/jquery.min.js"></script>
...
<script type="text/javascript" src="{{ asset('public/datatable') }}/js/dataTables.bootstrap.min.js"></script>
