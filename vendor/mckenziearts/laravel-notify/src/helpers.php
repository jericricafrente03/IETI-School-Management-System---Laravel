...
if (! function_exists('notifyJs')) {
    ...
    {
        return '<script type="text/javascript" src="'.asset('vendor/mckenziearts/laravel-notify/public/js/notify.js').'"></script>';
    }
}
...
if (! function_exists('notifyCss')) {
    ...
    {
        return '<link rel="stylesheet" type="text/css" href="'.asset('vendor/mckenziearts/laravel-notify/public/css/notify.css').'"/>';
    }
}
